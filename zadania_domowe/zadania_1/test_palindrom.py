...
class TestPalindrome(unittest.TestCase):
    ...
    def test_empty_string_as_a_palindrome(self):
        ...
        self.assertIs(is_palindrome, True)  # Zauwaz zmiane metody: assertIs, nie assertEqual
    ...
    def test_random_word_to_not_be_a_palindrome(self):
        ...
        is_palindrome = check_if_palindrome(string)
        self.assertFalse(is_palindrome)  # Teraz assertFalse, sprawdzamy czy random_string nie jest palindromem
